...
//  SolarSystemArKit
//
//  Created by Vedat Dokuzkardeş on 27.11.2023.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //let mySphere = createSphere(radius: 0.1, content: "carpet.png", vector: SCNVector3(0, 0.2, -1))
        
        let world = createSphere(radius: 0.1, content: "world.jpg", vector: SCNVector3(x: 0, y: 0.2, z: -1))
        
        let mars = createSphere(radius: 0.1, content: "mars.jpg", vector: SCNVector3(x: 0.5, y: 0.2, z: -1))
        
        let venus = createSphere(radius: 0.1, content: "venus.jpg", vector: SCNVector3(x: 1, y: 0.2, z: -1))
